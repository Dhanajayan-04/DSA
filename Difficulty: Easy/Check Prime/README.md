<h2><a href="https://www.geeksforgeeks.org/problems/check-prime/1?page=8&category=Arrays,CPP&difficulty=Basic,Easy&sortBy=submissions">Check Prime</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an integer<strong>&nbsp;n </strong>check if&nbsp;<strong>n</strong> is prime or not<strong>.</strong></span></p>
