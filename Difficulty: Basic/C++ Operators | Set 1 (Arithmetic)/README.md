<h2><a href="https://www.geeksforgeeks.org/problems/c-operators4602/1?page=12&category=Arrays,CPP&difficulty=Basic,Easy&sortBy=submissions">C++ Operators | Set 1 (Arithmetic)</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given two numbers A and B. Perform addition,multiplication, subtraction and&nbsp;division on these two numbers.</span></p>
