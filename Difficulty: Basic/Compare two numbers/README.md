<h2><a href="https://www.geeksforgeeks.org/problems/compare-two-numbers/1?page=8&category=Arrays,CPP&difficulty=Basic&sortBy=submissions">Compare two numbers</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 14pt;">You are given two numbers <strong>a&nbsp;</strong>and&nbsp;<strong>b</strong>. If&nbsp;<strong>a&nbsp;</strong>is greater than <strong>b&nbsp;</strong>print 1, otherwise print 0.</span></p>
