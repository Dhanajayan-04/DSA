<h2><a href="https://www.geeksforgeeks.org/problems/add-numbers-in-array/1?page=12&category=Arrays,Java&difficulty=Basic&sortBy=submissions">Add numbers in array</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">You will be given a vector of integers of size n containing the elements. Your task is to find the sum of all the integers present in the array.As the sum can be large you have to return a value in long long data type.</span></p>
